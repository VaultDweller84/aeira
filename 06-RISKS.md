...
| R-08 | **Esquecer de mudar `VERSAO` no `sw.js`** e os telemóveis ficarem presos a uma versão antiga | 3 | 2 | **6** | Documentado em F-09 e no INSTALAR; **desde o ADR-015 é regra escrita de commit** — mexer em `codigo/` obriga a mudar a `VERSAO` no mesmo commit | «não vejo a alteração» | Hugo |
...
3. **R-02 / R-03 / R-05 / R-11 / R-16 (12)** — empatados.
