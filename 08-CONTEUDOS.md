...
| Item | Valor |
|---|---|
| Morada | Largo do Município, 6090-543 Penamacor |
| Telefone | 277 394 106 · telemóveis 963 180 059 / 915 192 106 |
| Horário | 2.ª a 6.ª, 09h00–12h30 e 14h00–17h30 |
...
112 · Bombeiros 277 394 122 · GNR 277 394 274 · Portugal Chama 808 200 520
(8h–21h) · Centro de Saúde 277 390 020 / 935 970 044 ·
cspenamacor@ulscb.min-saude.pt · SNS 24 808 24 24 24 ·
**Linha do Cidadão Idoso 800 20 35 31** (dias úteis 9h30–17h30, Provedor de
Justiça) · Finanças 277 390 040 · Segurança Social 300 515 100 ·
Conservatória 277 394 260 · CTT 277 390 030 · Tribunal 277 090 000 ·
Escolas Ribeiro Sanches 277 390 090 · Serra da Malcata 277 394 467.

## Prazos e regras legais

| Tema | Regra | Validade |
|---|---|---|
| **Limpeza de terrenos** | 2026: prazo terminou a **31 de Maio** (prorrogado a 30 de Junho em concelhos com calamidade). Faixas: 50 m casas isoladas, 100 m aglomerados, 10 m construções agrícolas. Coimas 150–1500 € (pessoas). Fiscaliza GNR, ICNF, Câmara, vigilantes | ⚠ **muda todos os anos — rever em Março** |
| Queimas e queimadas | Autorização pela plataforma/app do ICNF ou na Junta. Queima = montinho até 4 m² e 1,3 m. Proibido em risco elevado/máximo. Coimas 500–5000 € (pessoas) | estável |
| Obras isentas de licença | Conservação, interiores sem mexer em estrutura/fachada, arrecadações ≤2,2 m e ≤10 m², muros ≤1,8 m fora da via pública, painéis solares. **Excepção: zonas de protecção de monumentos exigem sempre autorização** | RJUE + DL 10/2024 |
| Resposta da Câmara | Prazo legal para decidir pedido formal. Sem resposta: reforço por escrito, depois Livro de Reclamações Eletrónico ou Provedor de Justiça | estável |

## Apoios municipais `[F]`

**Cartão Penamacor Social** — gratuito, 60+ anos ou incapacidade ≥60%.
Transporte entre freguesias grátis, 25–50% em piscinas/ginásio/estádio, 25% em
termas e cultura, 10% em fotocópias. Entrega na Unidade de Educação, Ação
Social e Saúde, 2.ª a 6.ª 9h00–12h30 e 14h00–16h00.
**Programa abem** — medicamentos comparticipados sem pagar, via Dignitude.
**Apoio à habitação** e **apoio a despesas de saúde** — boletim na Câmara.
**Tarifa social da água.**

## Água `[F]`
Leituras de dois em dois meses por funcionário municipal; em falta, factura
por estimativa. Comunicar leitura por WhatsApp (foto do contador com nome e
morada), email ou balcão. Pagamento: tesouraria, CTT, Payshop, Multibanco,
débito directo. Contador novo: cartão de cidadão, documento da casa
(escritura/caderneta/licença), comprovativo de morada.

## Romarias e festas do concelho `[F]`

Fixas: Águas — São Marcos, 25 Abr · **Aldeia de João Pires — Nossa Senhora da
Graça, 8 Set; São Miguel, 29 Set** · Aldeia do Bispo — São Bartolomeu, 24 Ago ·
Aranhas — Nossa Senhora do Bom Sucesso, 3.º dom. Ago · Bemposta — Nossa
Senhora da Silva, 15 Ago · Benquerença — Nossa Senhora das Neves, 5 Ago ·
Anascer — Nossa Senhora da Saúde, 15 Ago · Meimão — Santo António, 2.º dom.
Ago · Meimoa — São Domingos, 2.º dom. Ago · Penamacor — Santo António 13 Jun,
São João 24 Jun, São Pedro 28 Jun · Salvador — Santa Sofia, 1.º dom. Set ·
Vale da Póvoa — Santiago, 2.º dom. Ago.

Móveis (dependem da Páscoa): Nossa Senhora do Incenso (Segunda de Páscoa, 2 km
de Penamacor) · Senhora do Bom Sucesso (2.º dom. depois da Páscoa, ~12 km na
direcção de Espanha) · Nossa Senhora da Quebrada (6.º dom. depois da Páscoa,
Benquerença) · **Nossa Senhora da Póvoa** (Segunda de Pentecostes, Vale da
Senhora da Póvoa — das maiores da Beira Baixa, de sábado a segunda).

Outros: **Festival da Chanfana**, Meimão, habitualmente em Abril.
...
| Fonte | Situação |
|---|---|
| cm-penamacor.pt | sem RSS, sem iCal, sem API. HTML com Open Graph. **Verificado** |
| Reconquista | sem RSS (`/feed` e `/rss` dão 404), sem secção por concelho |
| Diário Digital Castelo Branco | idem |
| Google News RSS | existe, mas o `robots.txt` do Google proíbe leitura automática — **não usar** |
| Google Calendar público | ICS estável, sem chave. **É a única fonte com contrato fiável** |

Páginas de origem: `cm-penamacor.pt` (contactos e horários, contactos úteis,
executivo municipal, juntas de freguesia, água e saneamento, ação social,
romarias, agenda cultural, notícias, requerimentos), `provedor-jus.pt`
(Linha do Cidadão Idoso), fontes públicas sobre limpeza de terrenos, queimas
e RJUE.
